...
def bma_details(action = "snapshot")
  ...
  @bma = {
    ...
    "working_dir" => integration_details["BMA_WORKING"],
    "properties" => "#{integration_details["BMA_PROPERTIES"]}_#{@p.get("BMA_MIDDLEWARE_PLATFORM", "was85")}.properties",
    "log_level" => "ERROR",
